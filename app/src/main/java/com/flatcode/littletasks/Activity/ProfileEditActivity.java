...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    String id = DATA.FirebaseUserUid;
    ...
    private void updateProfile(String imageUrl, String id, DatabaseReference ref) {
        ...
        ref.child(id).updateChildren(hashMap).addOnSuccessListener(unused -> {
            dialog.dismiss();
